...
<div style="width: 60%; margin: auto; background: white;">
	<form action="noticeWriteDO" method="post" name="writeForm" >
		...
		<input type="text" id="title" name="title" style="width: 40%;border: none; border-bottom: 2px solid black;" placeholder="제목" >
		<br><br> 
