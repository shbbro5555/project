...
<div style="width: 60%; margin: auto; background: white;">
	<form action="QnAModifyDO" method="post" name="modifyForm" >
		...
		<input type="text" id="title" name="title" style="width: 40%;border: none; border-bottom: 2px solid black;" value="${title}"><br><br>
